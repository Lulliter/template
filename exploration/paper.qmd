...
<!-- DOCX: one opens, one downloads -->
  <a class="btn btn-warning btn-sm mb-1" href="/manuscript/output/manuscript.docx" target="_blank" rel="noopener">
  <i class="fa-solid fa-file-word"></i>&ensp;DOCX
  </a>

  <a class="btn btn-warning btn-sm mb-1" target="_blank" href="/manuscript/output/manuscript.docx">
  <i class="fa-solid fa-file-arrow-down"></i>&ensp;DOCX <small>(download)</small>
  </a>
